  ...
  render() {
    return (
      <div className="about-container">
        ...
        <p> 
        The fresh-track team is brought to you by a Portland, Or dev team dedicated to bringing music lovers a new kind of music sharing experience. Fresh-track is a unique file repository that allows artists to upload, share, and collaborate on their unreleased music tracks from their Soundcloud, Bandcamp, Google Drive and Drop Box music libraries.
        </p>
